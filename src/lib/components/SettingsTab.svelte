...
<div class="max-w-3xl mx-auto space-y-6 animate-fade-in pb-12">
	...
	<Card noPadding={true}>
        <div class="bg-slate-50 px-6 py-4 border-b border-slate-100 rounded-t-xl">
        ...
        <div class="p-6 sm:p-8 space-y-8">
            <div>
                ...
                <Button
                    ...
                    variant="primary"
                    class="w-full py-3 sm:py-4 gap-3 shadow-md shadow-indigo-200"
                >
                    <Download size={20} />
	...
	<Card class="mt-8" noPadding={true}>
        <div
            class="px-6 py-4 border-b border-red-100 bg-red-100/50 flex items-center justify-center gap-2 rounded-t-xl"
        >
        ...
        <div class="p-6 flex flex-col items-center text-center">
            ...
            <Button
                ...
                variant="danger"
                class="px-6 py-2.5 text-sm font-bold gap-2 shadow-sm"
            >
                <Trash2 size={18} />
