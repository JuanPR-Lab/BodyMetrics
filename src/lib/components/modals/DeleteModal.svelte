		...
		>
			...
			<div class="px-6 py-6">
				...
				<div class="space-y-2">
					...
					>
						{placeholder}
						<span
							class="select-none text-slate-800 bg-slate-100 px-1.5 py-0.5 rounded border border-slate-200 font-mono"
			...
			<div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
				...
				<button
					on:click={confirm}
					disabled={!isMatch}
					class="px-4 py-2 bg-red-600 text-white font-bold text-sm rounded-lg shadow-sm flex items-center gap-2 transition-all {isMatch
